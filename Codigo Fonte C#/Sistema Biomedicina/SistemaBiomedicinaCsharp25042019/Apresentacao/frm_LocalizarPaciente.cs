...
namespace SistemaBiomedicinaCsharp25042019.Apresentacao
{
    public partial class frm_LocalizarPaciente : Form
    {
        ...
        private void btnPesquisar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    da = new SqlDataAdapter("sp_buscarPacientesNome", Conexao.Conexao.con);
        ...
        private void Listar()
        {
            ...
            {
                Conexao.Conexao.abrir();
                da = new SqlDataAdapter("SELECT * FROM pacientes", Conexao.Conexao.con);
                //PREENCHER A TABELA
                da.Fill(dt);
                dgLocalizarPac.DataSource = dt;
        ...
        private void btnExcluir_Click(object sender, EventArgs e)
        {
            ...
            if (txtIdPac.Text != "")
            {
                ...
                if (msgSN == DialogResult.Yes)
                {
                    ...
                    {
                        Conexao.Conexao.abrir();
                        cmd = new SqlCommand("sp_excluirPaciente", Conexao.Conexao.con);
        ...
        private void btnSelecionarMicro_Click(object sender, EventArgs e)
        {
            ...
            frm_Microbiologia.txtIdPac.SelectedText = System.Convert.ToString(dgLocalizarPac.CurrentRow.Cells[0].Value);
            frm_Microbiologia.txtNome.SelectedText = System.Convert.ToString(dgLocalizarPac.CurrentRow.Cells[1].Value);
            this.Close();
            this.Dispose();
        }
        ...
        private void btnSelecionarUrina_Click(object sender, EventArgs e)
        {
            ...
            frm_Urinalise.txtIdPac.SelectedText = System.Convert.ToString(dgLocalizarPac.CurrentRow.Cells[0].Value);
            frm_Urinalise.txtNome.SelectedText = System.Convert.ToString(dgLocalizarPac.CurrentRow.Cells[1].Value);
            this.Close();
            this.Dispose();
        }
        ...
        private void btnSelecionarHema_Click(object sender, EventArgs e)
        {
            ...
            frm_Hematologia.txtIdPac.SelectedText = System.Convert.ToString(dgLocalizarPac.CurrentRow.Cells[0].Value);
            frm_Hematologia.txtNome.SelectedText = System.Convert.ToString(dgLocalizarPac.CurrentRow.Cells[1].Value);
            this.Close();
            this.Dispose();
        }
        ...
        private void btnSelecionarBioq_Click(object sender, EventArgs e)
        {
            ...
            frm_Bioquimica.txtIdPac.SelectedText = System.Convert.ToString(dgLocalizarPac.CurrentRow.Cells[0].Value);
            frm_Bioquimica.txtNome.SelectedText = System.Convert.ToString(dgLocalizarPac.CurrentRow.Cells[1].Value);
            this.Close();
            this.Dispose();
        }
