...
namespace SistemaBiomedicinaCsharp25042019.Apresentacao
{
    public partial class frm_CadColaborador : Form
    {
        ...
        private void btnPesquisar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    da = new SqlDataAdapter("sp_buscarEstagiarioNome", Conexao.Conexao.con);
                ...
                {
                    MessageBox.Show("Erro no metodo listar", "Erro" + ex.Message, MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button2);
        ...
        private void Listar()
        {
            ...
            {
                Conexao.Conexao.abrir();
                da = new SqlDataAdapter("SELECT * FROM colaboradores", Conexao.Conexao.con);
                //PREENCHER A TABELA
                da.Fill(dt);
                dgColaborador.DataSource = dt;
        ...
        private void btnSalvar_Click(object sender, EventArgs e)
        {
                    ...
                    cmbNivel.Text != "")
            {
                ...
                {
                    Conexao.Conexao.abrir();
                    cmd = new SqlCommand("sp_salvarEstagiario", Conexao.Conexao.con);
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
                    ...
                    cmbNivel.Text != "")
            {
                ...
                {
                    Conexao.Conexao.abrir();
                    cmd = new SqlCommand("sp_editarEstagiario", Conexao.Conexao.con);
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        private void btnExcluir_Click(object sender, EventArgs e)
        {
            ...
            if (txtId.Text != "")
            {
                ...
                if (msgSN == DialogResult.Yes)
                {
                    ...
                    {
                        Conexao.Conexao.abrir();
                        cmd = new SqlCommand("sp_excluirEstagiario", Conexao.Conexao.con);
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        //BOTAR SELECIONAR PACIENTE PARA BIOQUIMICA
        public void btnSelecionarBio_Click(object sender, EventArgs e)
        {
            frm_Bioquimica frm_Bioquimica = new frm_Bioquimica();
            
            frm_Bioquimica.txtIdcola.SelectedText = System.Convert.ToString(dgColaborador.CurrentRow.Cells[0].Value);
            frm_Bioquimica.txtCola.SelectedText = System.Convert.ToString(dgColaborador.CurrentRow.Cells[1].Value);
            this.Close();
            this.Dispose();
        }
        ...
        private void btnSelecionarHema_Click(object sender, EventArgs e)
        {
            ...
            frm_Hematologia.txtIdcola.SelectedText = System.Convert.ToString(dgColaborador.CurrentRow.Cells[0].Value);
            frm_Hematologia.txtCola.SelectedText = System.Convert.ToString(dgColaborador.CurrentRow.Cells[1].Value);
            this.Close();
            this.Dispose();
        }
        ...
        private void btnSelecionarUri_Click(object sender, EventArgs e)
        {
            ...
            frm_Urinalise.txtIdcola.SelectedText = System.Convert.ToString(dgColaborador.CurrentRow.Cells[0].Value);
            frm_Urinalise.txtCola.SelectedText = System.Convert.ToString(dgColaborador.CurrentRow.Cells[1].Value);
            this.Close();
            this.Dispose();
        }
        ...
        private void btnSelecionarMicro_Click(object sender, EventArgs e)
        {
            ...
            frm_Microbiologia.txtIdcola.Text = System.Convert.ToString(dgColaborador.CurrentRow.Cells[0].Value);
            frm_Microbiologia.txtCola.Text = System.Convert.ToString(dgColaborador.CurrentRow.Cells[1].Value);
            this.Close();
            this.Dispose();
        }
    }
