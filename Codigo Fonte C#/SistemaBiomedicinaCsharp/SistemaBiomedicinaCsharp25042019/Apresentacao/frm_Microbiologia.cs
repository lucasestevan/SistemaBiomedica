...
namespace SistemaBiomedicinaCsharp25042019.Apresentacao
{
    public partial class frm_Microbiologia : Form
    {
        ...
        private void btncad_Click(object sender, EventArgs e)
        {
                ...
                txtBaar.Text != "")
            {
                try
                {
                    ...
                    cmd = new SqlCommand("sp_salvarExameMicro", Modelo.Estaticos.con);
        ...
        public void btnAlterarM_Click(object sender, EventArgs e)
        {
            ...
            {
                Modelo.Estaticos.abrir();
                cmd = new SqlCommand("sp_editarExameMicro", Modelo.Estaticos.con);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            PrintPreviewDialog1.Width = 950; //TAMANHO DA LARGURA
            PrintPreviewDialog1.Height = 800; //TAMANHO DA ALTURA
        ...
        {
            e.Graphics.DrawString("Colaborador:", txtCola.Font, Brushes.Black, 100, 100); //Colaborador
            e.Graphics.DrawString(txtCola.Text, txtCola.Font, Brushes.Black, 175, 150);
            e.Graphics.DrawString("Paciente:", txtNome.Font, Brushes.Black, 100, 100); //Paciente
            e.Graphics.DrawString(txtNome.Text, txtNome.Font, Brushes.Black, 165, 100);
            ...
            e.Graphics.DrawString("Nº  dia:", mskData.Font, Brushes.Black, 220, 125); //nº dia
            e.Graphics.DrawString(txtNdia.Text, txtNdia.Font, Brushes.Black, 260, 125);
            e.Graphics.DrawString("Data:", mskData.Font, Brushes.Black, 100, 125); //
            e.Graphics.DrawString(mskData.Text, mskData.Font, Brushes.Black, 140, 125);
        }
    }
}
